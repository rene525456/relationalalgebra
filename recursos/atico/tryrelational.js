//
// Patched by: Roto Zalapeva (c) 
// RZ We need a reference to the console
var miconsola;
...
(function($){
    ...
    $(document).ready(function(){
        ...
        // RZ Esta función es la que simula una llamada jsonp realmente esta cheating porque
        // lo que se retorna es un script js y mas abajo el handleJSON llama a la funcion
        // que el script retorna
        ...
        controller = consola.console({
            ...
            commandHandle:function(line,report){
                controller.ajaxloader = $('<p class="ajax-loader">Cargando...</p>');
                var commandRef = {};
                ...
                // RZ: Aqui dispara las llamadas al libTrigger, si consigue algo de ahi
                // retorna, esto es util para armar el tutorial a la final, pero si no
                // va hacia abajo a obtener una respuesta desde el json
                ...
                // RZ Aquí hace la llamada al json, hagamos una llamada a flask
                jsonp("/relational.json?method=eval&pad=handleJSON&expr=" + encodeHex(line) + "&random=" + Math.random(),
                      function(resp){
            ...
            charInsertTrigger:function(){
                var t = notice('tellaboutreturn',
                               "Presione Enter cuando termine de "+
                               "ingresar la expresion.");
                if (t) tellAboutRet = t;
                return true;
            },
            autofocus:true,
            ...
            welcomeMessage:'Escriba una expresion relacional aqui:'
        });
        ...
        //RZ referenciar aqui a la consola
        miconsola = controller;
    ...
    //RZ Aqui se crea el tag code que al hacer click se inserta en la consola
    function makeGuidSamplesClickable() {
        $('.guide code').each(function(){
            $(this).css('cursor','pointer');
            $(this).attr('title','Haga click para insertar "' +
